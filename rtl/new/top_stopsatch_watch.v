...
//=============================================================
    ...
    assign w_sw_clk_out0 = (or_btn_r | i_btn_u) & w_mode_swclk;
    assign w_sw_clk_out1 = (or_btn_c | i_btn_d) & w_mode_swclk;
    assign w_sw_clk_out2 = (or_btn_n | i_btn_m) & w_mode_swclk;

    assign i_run_stop = w_sw_clk_out0;
    assign i_clear = w_sw_clk_out1;
    assign cu_btn_m = w_sw_clk_out2;
...
//=============================================================  
    ...
    clk_datapath U_CLOCK_DATAPATH (
        ...
        .c_msec(w_watch_time[6:0]),
        .c_sec (w_watch_time[12:7]),
        .c_min (w_watch_time[18:13]),
        .c_hour(w_watch_time[23:19]),
        .led(w_clk_sel_led)
    );
